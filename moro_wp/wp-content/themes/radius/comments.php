...
<div id="respond">
	...
	<!-- Comment inputs -->
	<p><input class="form-author" type="text" name="author" id="author" onfocus="if (this.value == 'Name (required)') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Name (required)';}" value="Name (required)" size="22" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> /></p>
	
	<p><input class="form-email" type="text" name="email" id="email" onfocus="if (this.value == 'Email (required)') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Email (required)';}" value="Email (required)" size="22" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> /></p>
	
	<p><input class="form-website" type="text" name="url" id="url" onfocus="if (this.value == 'Website') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Website';}" value="Website" size="22" tabindex="3" /></p>
