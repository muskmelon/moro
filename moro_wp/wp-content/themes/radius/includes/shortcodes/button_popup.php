...
<script language="javascript" type="text/javascript" src="<?php echo bloginfo('template_url') ?>/includes/shortcodes/includes/js/popup-tabs.js"></script>
<style type="text/css" src="<?php echo includes_url($path); ?>js/tinymce/themes/advanced/skins/wp_theme/dialog.css"></style>
<link rel="stylesheet" href="<?php echo bloginfo('template_url') ?>/includes/shortcodes/includes/css/friendly_buttons_tinymce.css" />
				...
				<form action="/" method="get" accept-charset="utf-8">
					...
					<div>
						...
						<select name="column-width" id="column-width" size="1">
							<option value="two-third" selected="selected">2/3 Column</option>
							<option value="two-third-last">2/3 Column (Last)</option>
							<option value="one-third">1/3 Column</option>
							<option value="one-third-last">1/3 Column (Last)</option>
							<option value="one-sixth">1/6 Column</option>
							<option value="one-sixth-last">1/6 Column (Last)</option>
						</select>
					</div>
