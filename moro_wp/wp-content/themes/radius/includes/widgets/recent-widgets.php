				...
				<?php if ( $twitteruser ) { ?>
					<div class="pane">
						<div class="twitter-box">
							 ...
							 <div class="tweets-more"><a href="http://twitter.com/<?php echo $instance['twitteruser']; ?>" target="_blank" title="twitter"><?php _e('Follow','okay'); ?> @<?php echo $instance['twitteruser']; ?> &rarr;</a>
							 </div>
						</div>
					</div><!-- twitter pane -->
				<?php } ?>
